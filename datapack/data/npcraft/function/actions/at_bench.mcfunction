...
execute if data entity @s data.agent{intent:"craft_furnace"} run return run function npcraft:actions/recipes/furnace
execute if data entity @s data.agent{intent:"craft_iron_pick"} run return run function npcraft:actions/recipes/iron_pick
execute if data entity @s data.agent{intent:"craft_iron_sword"} run return run function npcraft:actions/recipes/iron_sword
