...
function npcraft:inventory/remove {kind:"minecraft:cobblestone",count:8}
...
data modify storage npcraft:inv input set value {"item":{"id":"minecraft:furnace","count":1},"max":64}
