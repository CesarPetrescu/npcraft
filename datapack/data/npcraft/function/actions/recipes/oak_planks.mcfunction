...
function npcraft:inventory/remove {kind:"minecraft:oak_log",count:1}
...
data modify storage npcraft:inv input set value {item:{id:"minecraft:oak_planks",count:4},max:64}
