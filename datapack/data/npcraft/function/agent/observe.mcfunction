...
function npcraft:inventory/count {kind:"minecraft:wooden_pickaxe"}
scoreboard players operation #ag_wood_pick np.tmp = #iv_total np.tmp
execute store result entity @s data.agent.observed.wood_pick int 1 run scoreboard players get #iv_total np.tmp
function npcraft:inventory/count {kind:"minecraft:stone_pickaxe"}
scoreboard players operation #ag_stone_pick np.tmp = #iv_total np.tmp
execute store result entity @s data.agent.observed.stone_pick int 1 run scoreboard players get #iv_total np.tmp
