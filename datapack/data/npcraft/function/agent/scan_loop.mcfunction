...
execute if data entity @s data.agent.target run return 1
...
execute store result score #scanned np.tmp run data get entity @s data.agent.scanned
execute if score #scanned np.tmp matches ..195 run scoreboard players add #scanned np.tmp 1
execute store result entity @s data.agent.scanned int 1 run scoreboard players get #scanned np.tmp
execute store result score #index np.tmp run data get entity @s data.agent.scan
...
execute store result entity @s data.agent.scan int 1 run scoreboard players get #index np.tmp
