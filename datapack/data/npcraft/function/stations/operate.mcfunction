...
$execute if items block $(x) $(y) $(z) container.0 * unless items block $(x) $(y) $(z) container.0 minecraft:raw_iron run return run function npcraft:actions/result {state:"blocked",reason:"foreign_furnace_input"}
$execute if items block $(x) $(y) $(z) container.1 * unless items block $(x) $(y) $(z) container.1 minecraft:coal run return run function npcraft:actions/result {state:"blocked",reason:"foreign_furnace_fuel"}
